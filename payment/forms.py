    ...
    class Meta:
        ...
        widgets = {
            ...
            "shipping_address1": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Address One"}
            ),
            "shipping_address2": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Address Two"}
            ),
            "building_name": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Building Name / Home / Hotel",
                }
            ),
            ...
            "shipping_state": forms.TextInput(
...
class PaymentForm(forms.Form):
    ...
    card_address1 = forms.CharField(
        ...
        required=True,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Billing Adddress 1"}
        ),
    )
    card_address2 = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Billing Adddress 2"}
        ),
    )
